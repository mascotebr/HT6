...
export function Banner() {
  return (
    <div className="banner">
      ...
      >
        <iframe width="714" height="399" src="https://www.youtube.com/embed/zxJGsQCqkOc?autoplay=0&showinfo=0&controls=0&iv_load_policy=3&rel=0" title="Projeto HT6" ></iframe>
      </center>
